...
public class MoiDangAdapter extends RecyclerView.Adapter<MoiDangAdapter.ViewHolder> {
    ...
    public MoiDangAdapter(List<Story> storyList, OnItemClickListener onItemClick) {
